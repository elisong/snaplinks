...
> 以下内容由命令 `/opt/hostedtoolcache/Python/3.8.7/x64/bin/gsearch data visualization --num 30 --output-file 2021-02-27` 生成
...
- [Are you a Slack purist? Plus, the most encouraging data visualization of the year so far: Datacenter Weekly | Ad Age](https://adage.com/article/datacenter/are-you-slack-purist-plus-most-encouraging-data-visualization-year-so-far-datacenter-weekly/2317591)
